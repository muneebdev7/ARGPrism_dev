...
DEFAULT_PREDICTED_ARGS_FASTA_FILENAME = "predicted_ARGs.fasta"
DEFAULT_DIAMOND_DATABASE_PREFIX = "diamond_arg_db"
DEFAULT_DIAMOND_BLAST_OUTPUT_FILENAME = "predicted_ARGs_vs_ref.tsv"
DEFAULT_FINAL_REPORT_CSV_FILENAME = "final_ARG_prediction_report.csv"